(function () {
    var data_url = '//s3.amazonaws.com/org-emissionsindex/js/Fuel-Chart/annual_gen_website.csv';
    var d3_ag = Plotly.d3;
    ...
    var plot_options_ag = {
        ...
        modeBarButtonsToAdd: [{
            ...
            click: function (gd) {
                ...
                window.location.href = '//s3.amazonaws.com/org-emissionsindex/js/Data-Downloads/2019-Q2-US-Generation-By-Fuel-Type.xlsx';
            }
        }],
        displaylogo: false,
    ...
    d3_ag.csv(data_url, function (error, data) {
        if (error) {
            ...
            if (initial_width_ag < 500) {
                ...
                data_ag[arrayLength - 1].name = "Other Renew.";
