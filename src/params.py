...
DATA_DATE = '2021 -05-23' #e.g, in 2020: for Q1, '2020-03-01'; for Q2, '2020-06-01'; for Q3, '2020-09-01'; for Q4, '2020-12-01' Note that the string here is only used for naming different data files, so the actual date and numbers are unimportant from a data gathering/anlaysis perspective--they only tell the user when that data was created via the filename. Stick with the convention above for consistency;
