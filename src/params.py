...
DATA_DATE = '2022-11-01' #e.g, in 2020: for Q1, '2020-03-01'; for Q2, '2020-06-01'; for Q3, '2020-09-01'; for Q4, '2020-12-01' Note that the string here is only used for naming different data files, so the actual date and numbers are unimportant from a data gathering/anlaysis perspective--they only tell the user when that data was created via the filename. Stick with the convention above for consistency;
FINAL_DATA_YEAR = 2022
LAST_ANNUAL_923_YEAR = 2021 # Most recent year of annual (full) 923 release
...
DATA_PATHS['web_files_archive'] = project_path / 'web_files_archive'
...
CEMS_BASE = 'gaftp.epa.gov'
#CEMS_BASE = 'ftp://newftp.epa.gov/'
